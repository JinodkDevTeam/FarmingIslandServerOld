...
class MyStatusPCommand extends Command{
	private $plugin;

	public function __construct(PointAPI $plugin){
		$desc = $plugin->getCommandMessage("mystatusp");
		parent::__construct("mystatusp", $desc["description"], $desc["usage"]);

		$this->setPermission("pointapi.command.mystatusp");
