            ...
            for ($j = 1; $j <= $y; $j++) {
                ...
                switch ($this->core->mine[$i][$j])
                {
                    ...
                    case 0:
                        ...
                        break;
                    case 1:
                        $level->setBlock($pos, Block::get(Block::WOOL, 3), false, true);
                        break;
                    case 2:
                        $level->setBlock($pos, Block::get(Block::WOOL, 5), false, true);
                        break;
                    case 3:
                        $level->setBlock($pos, Block::get(Block::WOOL, 4), false, true);
                        break;
                    case 4:
                        $level->setBlock($pos, Block::get(Block::WOOL, 1), false, true);
                        break;
                    case 5:
                        $level->setBlock($pos, Block::get(Block::WOOL, 14), false, true);
                        break;
                    case 6:
                        $level->setBlock($pos, Block::get(Block::WOOL, 6), false, true);
                        break;
                    case 7:
                        $level->setBlock($pos, Block::get(Block::WOOL, 2), false, true);
                        break;
                    case 8:
                        $level->setBlock($pos, Block::get(Block::WOOL, 8), false, true);
                        break;
                    case 10:
